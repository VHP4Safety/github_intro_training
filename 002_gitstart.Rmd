...
Marc will do this live during the workshop and you will -hopefully- click along. In case you forget the procedure, [see this link.](https://docs.github.com/en/get-started/quickstart/create-a-repo)


## C: Github main workflow

### EXERCISE: main workflow (10 min) {.blauw}
Complete the [hello world](https://docs.github.com/en/get-started/quickstart/hello-world) exercise on Github
