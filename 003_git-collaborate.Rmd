...
If you're creating an open source project, we strongly encourage you to include an open source license. Data stewards will probably know more about this than we do, but if you need help choosing a license, see [this website](https://choosealicense.com/). (In case of the RIVM send an email to datastewards@rivm.nl)
